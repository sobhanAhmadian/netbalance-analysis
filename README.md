...
- Unzip the downloaded file and place the `data_repository` folder in the `src/netbalance/data_repository/` path or set the `DATA_DIR` environment variable to the path of the `data_repository` folder.

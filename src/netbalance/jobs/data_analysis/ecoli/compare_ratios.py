...
beta_phage_ratios = np.loadtxt(f"{ratios_folder}/beta/ratios_phage.txt", delimiter=",")
...
rho_phage_ratios = np.loadtxt(f"{ratios_folder}/rho/ratios_phage.txt", delimiter=",")
...
beta_bacteria_ratios = np.loadtxt(
    f"{ratios_folder}/beta/ratios_bacteria.txt", delimiter=","
)
...
rho_bacteria_ratios = np.loadtxt(
    f"{ratios_folder}/rho/ratios_bacteria.txt", delimiter=","
)

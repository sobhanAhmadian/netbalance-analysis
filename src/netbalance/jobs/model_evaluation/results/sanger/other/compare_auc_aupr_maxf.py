...
path_dict = [
    (BMLPSYN_RESULTS_DIR, "irho", "UnbiasNet"),
    (CCSYNERGY_RESULTS_DIR, "beta", "  CCSynergy"),
    (BRFSYN_RESULTS_DIR, "beta", "RF"),
    (BXGBSYN_RESULTS_DIR, "beta", "XGBoost"),
    (BLINSYN_RESULTS_DIR, "beta", "Linear"),
    ...
    (C_DEGREE_RATIO_RESULTS_DIR, "beta", "Cell Line"),

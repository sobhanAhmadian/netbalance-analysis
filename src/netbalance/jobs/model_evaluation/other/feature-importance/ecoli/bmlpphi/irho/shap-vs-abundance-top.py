...
print(np.percentile(mean_abs_shap, [99.75, 99.50, 99.25]))

n_features = 500  # Select top n important features
top_idx = np.argsort(mean_abs_shap)[-n_features:]
top_mask = np.zeros(len(mean_abs_shap), dtype=bool)
...
file_name = f"{figs_folder}/shap_vs_abundance_top_{n_features}.svg"

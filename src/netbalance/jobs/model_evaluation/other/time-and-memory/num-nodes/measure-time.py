...
time_usages_both = np.zeros((len(num_nodes_list), len(seeds)))
time_usages_heuristic = np.zeros((len(num_nodes_list), len(seeds)))
time_usages_sa = np.zeros((len(num_nodes_list), len(seeds)))

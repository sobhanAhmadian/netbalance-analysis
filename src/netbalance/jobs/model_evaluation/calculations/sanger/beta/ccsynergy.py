...
from netbalance.configs.ccsynergy import (
    CCSYNERGY_RESULTS_DIR as RESULTS_DIR,  # Parameter
)
from netbalance.configs.ccsynergy import (
    CCSynergyModelConfig as ModelConfig,  # Parameter
)
from netbalance.configs.ccsynergy import (
    CCSynergyOptimizerConfig as OptimizerConfig,  # Parameter
)
...
from netbalance.models.ccsynergy import (
    CCSynergyHandlerFactory as HandlerFactory,  # Parameter
)
from netbalance.optimization.ccsynergy import CCSynergyTrainer as Trainer  # Parameter
from netbalance.utils import prj_logger

logger = prj_logger.getLogger(__name__)

model_name = "ccsynergy"  # Parameter

...
XGBMDA_RAW_DATA_DIR = os.path.join(RAW_DATA_DIR, "xgbmda")
XGBMDA_PROCESSED_DATA_DIR = os.path.join(PROCESSED_DATA_DIR, "xgbmda")
XGBMDA_MODEL_SAVED_DIR = os.path.join(MODEL_SAVED_DIR, "xgbmda")
XGBMDA_RESULTS_DIR = os.path.join(XGBMDA_PROCESSED_DATA_DIR, "results")


class XGBMDAModelConfig(ModelConfig):
    def __init__(self):
        super().__init__()
...
class XGBMDAOptimizerConfig(OptimizerConfig):
    ...
    def __init__(self) -> None:
        ...
        self.batch_size = 32
        self.n_epoch = 50
        self.exp_name = "XGBMDA optimizer"
        self.device = "cpu"
        self.report_size = 10
        self.threshold = 0.5

...
from netbalance.configs.bxgbphi import BXGBPHIOptimizerConfig
...
from netbalance.models.bxgbphi import BXGBPHIModelHandler
...
class BXGBPHITrainer(Trainer):

    def train(
        self,
        model_handler: BXGBPHIModelHandler,
        data: BGData,
        config: BXGBPHIOptimizerConfig,
    ) -> Result:

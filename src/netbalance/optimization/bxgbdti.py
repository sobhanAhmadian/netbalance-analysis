...
from netbalance.configs.bxgbdti import BXGBDTIOptimizerConfig
...
from netbalance.models.bxgbdti import BXGBDTIModelHandler
...
class BXGBDTITrainer(Trainer):

    def train(
        self,
        model_handler: BXGBDTIModelHandler,
        data: BGData,
        config: BXGBDTIOptimizerConfig,
    ) -> Result:

...
from netbalance.configs.blinphi import BLINPHIOptimizerConfig
...
from netbalance.models.blinphi import BLINPHIModelHandler
...
class BLINPHITrainer(Trainer):

    def train(
        self,
        model_handler: BLINPHIModelHandler,
        data: BGData,
        config: BLINPHIOptimizerConfig,
    ) -> Result:

...
from netbalance.configs.brfphi import BRFPHIOptimizerConfig
...
from netbalance.models.brfphi import BRFPHIModelHandler
...
class BRFPHITrainer(Trainer):

    def train(
        self,
        model_handler: BRFPHIModelHandler,
        data: BGData,
        config: BRFPHIOptimizerConfig,
    ) -> Result:

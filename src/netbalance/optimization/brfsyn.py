...
from netbalance.configs.brfsyn import BRFSYNOptimizerConfig
...
from netbalance.models.brfsyn import BRFSYNModelHandler
...
class BRFSYNTrainer(Trainer):

    def train(
        self,
        model_handler: BRFSYNModelHandler,
        data: TGData,
        config: BRFSYNOptimizerConfig,
    ) -> Result:

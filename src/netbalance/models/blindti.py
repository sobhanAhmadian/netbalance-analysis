...
from netbalance.configs.blindti import BLINDTI_PROCESSED_DATA_DIR, BLINDTIModelConfig
...
class BLINDTIFeatureExtractor(FeatureExtractor):
...
class BLINDTIModelHandler(AModelHandler):
    ...
    def _build_feature_extractor(self):
        return BLINDTIFeatureExtractor(self.model_config)


class BLINDTIHandlerFactory(HandlerFactory):

    def __init__(self, model_config: BLINDTIModelConfig) -> None:
        super().__init__()
        self.model_config = model_config

    def create_handler(self) -> BLINDTIModelHandler:
        return BLINDTIModelHandler(self.model_config)

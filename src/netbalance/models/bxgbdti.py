...
from netbalance.configs.bxgbdti import BXGBDTI_PROCESSED_DATA_DIR, BXGBDTIModelConfig
...
class BXGBDTIFeatureExtractor(FeatureExtractor):
...
class BXGBDTIModelHandler(AModelHandler):
    ...
    def _build_feature_extractor(self):
        return BXGBDTIFeatureExtractor(self.model_config)


class BXGBDTIHandlerFactory(HandlerFactory):

    def __init__(self, model_config: BXGBDTIModelConfig) -> None:
        super().__init__()
        self.model_config = model_config

    def create_handler(self) -> BXGBDTIModelHandler:
        return BXGBDTIModelHandler(self.model_config)

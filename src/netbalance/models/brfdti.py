...
from netbalance.configs.brfdti import BRFDTI_PROCESSED_DATA_DIR, BRFDTIModelConfig
...
class BRFDTIFeatureExtractor(FeatureExtractor):

    def __init__(self, model_config: BRFDTIModelConfig) -> None:
        super().__init__()
...
class BRFDTIModelHandler(BGCModelHandler):
    ...
    def _build_feature_extractor(self):
        return BRFDTIFeatureExtractor(self.model_config)


class BRFDTIHandlerFactory(HandlerFactory):

    def __init__(self, model_config: BRFDTIModelConfig) -> None:
        super().__init__()
        self.model_config = model_config

    def create_handler(self) -> BRFDTIModelHandler:
        return BRFDTIModelHandler(self.model_config)
